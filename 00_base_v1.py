...
class Quiz:
    ...
    def __init__(self, how_many):
        ...
        self.blank_row.grid(row=1, column=0, pady=20)
        ...
        self.fear_label.grid(row=2, column=0, padx=10, pady=60, sticky=N)

        # create quiz frame (buttons)
        self.quiz_frame = Frame(self.text_frame)
        self.quiz_frame.grid(row=2, column=1)
        ...
        self.correct_incorrect_label.grid(row=3, columnspan=2, pady=10)

        # adds a blank row to place 'next button' at bottom of window
        self.blank = Label(self.quiz_frame, text="")

        self.blank.grid(row=4, column=1, pady=20)
